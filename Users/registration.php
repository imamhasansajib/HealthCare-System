  ...
  $_POST[".$d_date."];
	 ...
	 /*     elseif(!filter_var($d_contact,FILTER_VALIDATE_INT)){
	  ...
	  elseif($pswd_len<=8)
	   ...
	   { $d_query="INSERT INTO user(f_name,l_name,email,contact,address,DOB,gender,maritialstatus,pswd,date)     
	                            VALUES('$f_name','$l_name','$email','$contact','$address','$DOB','$gender','$maritialstatus','$pswd','$date')";
